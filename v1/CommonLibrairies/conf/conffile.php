...
Define('COPYRIGHT','Tous droits réservés 2004-2005 &copy; <a class="Copyright" href="mailto:cyrille2@free.fr">BERLIAT Cyrille</a>');
...
$GLOBALS['jsfile'] = EXT_URL.'js/gen.php';// absolute path recommanded
